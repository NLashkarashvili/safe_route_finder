...
def plot_routes(start_lat, start_lon, end_lat, end_lon, radius=800, output_file=None):
    ...
    ax.scatter(start_lon, start_lat, c='red', s=100, zorder=5)
    ax.scatter(end_lon, end_lat, c='red', s=100, zorder=5)
    
    # Add legend and title
    ax.legend(['Street Network', 'Shortest Route', 'Safest Route', 'Start/End Points'], loc='best')
    plt.title(f'Shortest vs. Safest Route')
